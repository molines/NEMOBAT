...
!                            default value for file name: 
    chfilin1  = '../bathy_meter_treated_ORCA_R05_checked_coast_nobug.nc'
    chfilout  = '../bathy_meter_treated_ORCA_R05_checked_coast_nobug_tpenduff.nc'

!                             read actual bathymetry filename
   print *,' file name for bathy to correct, ''y'' for default:',trim(chfilin1)
     read(5,*) chanswer
...
! -------------------------------------------------------------------
!   include 'orca05_hand_modif_october05.h90'
!!!!!!!!Thierry : MODIF gibraltar v2 de Rafael.
! include 'orca05_hand_modif_oct05_G44.h90'
!  include  'orca05_hand_modif_oct05_G45.h90'
...
!
    ...
    elseif (jpi== 1442 .AND.jpj==1021) then
         nperio= 4
         print *, 'This is an ORCA R05 configuration, nperio=4'
    else
